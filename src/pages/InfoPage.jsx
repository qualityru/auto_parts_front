...
const PAGE_CONTENT = {
  delivery: {
    title: 'Доставка',
    subtitle: 'Логистика TABROS: от выбора склада до отслеживания поставки в одном интерфейсе.',
  ...
  about: {
    title: 'О нас',
    subtitle: 'TABROS объединяет поставщиков и клиентов в единой цифровой платформе автозапчастей.',
    ...
    sections: [
      ...
      { title: 'Где получить товар', items: ['Пункт выдачи: ст. Гостагаевская, ул. Комсомольская, д. 177', 'Время работы: Пн-Пт 09:00-20:00, Сб-Вс 10:00-18:00', 'Самовывоз из пункта выдачи без дополнительной комиссии'] },
      { title: 'Для кого', items: ['Автовладельцы.', 'СТО и сервисные центры.', 'Магазины автозапчастей и корпоративные клиенты.'] },
    ],
  },
  contacts: {
    title: 'Контакты',
    subtitle: 'Команда TABROS на связи по всем вопросам подбора, поставки и сотрудничества.',
    ...
    sections: [
      { title: 'Клиентская поддержка', items: ['Телефон: +7 (988) 347-47-06', 'Время работы: Пн-Пт 09:00-20:00, Сб-Вс 10:00-18:00'] },
      { title: 'Отдел продаж', items: ['Телефон: +7 (988) 347-47-06', 'Работа с оптовыми и корпоративными заказами.'] },
      { title: 'Реквизиты', items: ['ИП Богданова Арина Дмитриевна', 'ИНН: 910611514931', 'ОГРНИП: 325911200145376', 'Юридический адрес: ст. Гостагаевская, ул. Комсомольская, д. 177'] },
    ],
  },
  partners: {
    title: 'Партнерам',
    subtitle: 'Подключайтесь к TABROS: новые продажи, автоматизация и расширение клиентской базы.',
